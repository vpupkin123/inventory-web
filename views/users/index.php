                ...
                <tr>
                    ...
                    <td style="padding: 10px; border: 1px solid #ddd;">
                        <?php if (!$isWarehouse && !$isSelf): ?>
                            ...
                            <a href="/users/block?id=<?= $u['id'] ?>" class="btn" style="padding: 5px 10px; font-size: 0.9em; background: #dc3545;" onclick="return confirm('Are you sure?');"><?= Lang::t('users.block') ?></a>
                        <?php else: ?>
